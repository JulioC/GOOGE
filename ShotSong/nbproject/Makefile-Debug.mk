...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shotsong: ../Engine/dist/Debug/GNU-Linux-x86/libengine.a
...
${OBJECTDIR}/PlayerSprite.o: PlayerSprite.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Engine/includes -Iincludes -MMD -MP -MF $@.d -o ${OBJECTDIR}/PlayerSprite.o PlayerSprite.cpp
...
${OBJECTDIR}/ShotSong.o: ShotSong.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Engine/includes -Iincludes -MMD -MP -MF $@.d -o ${OBJECTDIR}/ShotSong.o ShotSong.cpp

${OBJECTDIR}/MapLayer.o: MapLayer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Engine/includes -Iincludes -MMD -MP -MF $@.d -o ${OBJECTDIR}/MapLayer.o MapLayer.cpp

${OBJECTDIR}/FirstLevel.o: FirstLevel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../Engine/includes -Iincludes -MMD -MP -MF $@.d -o ${OBJECTDIR}/FirstLevel.o FirstLevel.cpp
